...
from asr.local_whisper import save_transcript, transcribe_with_faster_whisper
from core.media_capture import available_capture_methods, capture_video, extract_audio, probe_audio
