...
Usage (from collector/main):
    from asr_sensevoice import core_transcribe_for_record
...
def run_asr_pipeline(record, wav_path: str, video_identifier: str) -> None:
    ...
    try:
        from asr_xunfei import core_transcribe_for_record as _fn
    ...
    try:
        from asr_paraformer import core_transcribe_for_record as _fn
        _fn(record, wav_path, video_identifier)
        _run_script_match(record)
        return
    except (FileNotFoundError, ImportError) as e:
